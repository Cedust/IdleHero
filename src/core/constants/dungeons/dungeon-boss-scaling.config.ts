...
export const DUNGEON_BOSS_SCALING: Record<string, DungeonBossScalingParams> = {
  ...
  C1: {
    BossBaseHealth: 2_000_000,
    r: 1.016,
    a: 0.001,
    b: 1.45,
    MidBossMultiplier: 5,
    EndBossMultiplier: 10
  },
  C2: {
    BossBaseHealth: 20_000_000,
    r: 1.016,
    a: 0.001,
    b: 1.45,
    MidBossMultiplier: 5,
  ...
  C4: {
    BossBaseHealth: 1_000_000_000,
    r: 1.016,
    a: 0.001,
    b: 1.45,
    MidBossMultiplier: 5,
    EndBossMultiplier: 11.6522934004
  }
};
